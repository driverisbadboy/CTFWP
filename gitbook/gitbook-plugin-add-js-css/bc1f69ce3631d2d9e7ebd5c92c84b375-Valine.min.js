var pathname = window.location.pathname;if(pathname.substr(0,10) == '/articals/' || pathname.substr(0,11) == '/reply.html'){$("section").append("<div class='comment'></div>");}
!function(e, t) {
...
function() {
    ...
    function(e, t, n) {
        ...
        function c(e, t, n, r) {
            if (n = g(n), "href" === t || "src" === t) {
                ...
                if (E.lastIndex = 0, E.test(n) && (R.lastIndex = 0, R.test(n))) return ""; ! 1 !== r && (r = r || S, n = r.process(n))
            }
            return n = v(n)
        }
        function u(e) {
    ...
    function(e, t, n) { (function(t) { !
            function(t) {
                ...
                function n(e) {
                    ...
                    this.rules = x.normal,
                    this.options.pedantic ? this.rules = x.pedantic: this.options.gfm && (this.options.tables ? this.rules = x.tables: this.rules = x.gfm)
                }
                function r(e, t) {
                ...
                function l(e, t) {
                    if (t) {
                        if (l.escapeTest.test(e)) return e.replace(l.escapeReplace,
                        function(e) {
                            return l.replacements[e]
                        })
                    } else if (l.escapeTestNoEncode.test(e)) return e.replace(l.escapeReplaceNoEncode,
                    function(e) {
                        return l.replacements[e]
                    });
                    return e
                ...
                function d(e, t) {
                    return y[" " + e] || (/^[^:]+:\/*[^\/]*$/.test(e) ? y[" " + e] = e + "/": y[" " + e] = v(e, "/", !0)),
                    e = y[" " + e],
                ...
                function b(e, t, r) {
                    ...
                    if (r || "function" == typeof t) {
                        ...
                        for (; c < i.length; c++) !
                        function(e) {
                            "code" !== e.type ? --o || u() : s(e.text, e.lang,
                            function(t, n) {
                ...
                x._label = /(?!\s*\])(?:\\[\[\]]|[^\[\]])+/,
                x._title = /(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/,
                x.def = u(x.def).replace("label", x._label).replace("title", x._title).getRegex(),
                x.bullet = /(?:[*+-]|\d{1,9}\.)/,
                x.item = /^( *)(bull) ?[^\n]*(?:\n(?!\1bull ?)[^\n]*)*/,
                x.item = u(x.item, "gm").replace(/bull/g, x.bullet).getRegex(),
                x.list = u(x.list).replace(/bull/g, x.bullet).replace("hr", "\\n+(?=\\1?(?:(?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$))").replace("def", "\\n+(?=" + x.def.source + ")").getRegex(),
                x._tag = "address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|section|source|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",
                x._comment = /<!--(?!-?>)[\s\S]*?-->/,
                x.html = u(x.html, "i").replace("comment", x._comment).replace("tag", x._tag).replace("attribute", / +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),
                x.paragraph = u(x.paragraph).replace("hr", x.hr).replace("heading", x.heading).replace("lheading", x.lheading).replace("tag", x._tag).getRegex(),
                x.blockquote = u(x.blockquote).replace("paragraph", x.paragraph).getRegex(),
                x.normal = f({},
                x),
                x.gfm = f({},
                x.normal, {
                ...
                x.gfm.paragraph = u(x.paragraph).replace("(?!", "(?!" + x.gfm.fences.source.replace("\\1", "\\2") + "|" + x.list.source.replace("\\1", "\\3") + "|").getRegex(),
                x.tables = f({},
                x.gfm, {
                    nptable: /^ *([^|\n ].*\|.*)\n *([-:]+ *\|[-| :]*)(?:\n((?:.*[^>\n ].*(?:\n|$))*)\n*|$)/,
                    table: /^ *\|(.+)\n *\|?( *[-:]+[-| :]*)(?:\n((?: *[^>\n ].*(?:\n|$))*)\n*|$)/
                ...
                n.prototype.token = function(e, t) {
                    e = e.replace(/^ +$/gm, "");
                    for (var n, r, i, o, a, s, l, c, u, p, d, h, f, m, b, w; e;) if ((i = this.rules.newline.exec(e)) && (e = e.substring(i[0].length), i[0].length > 1 && this.tokens.push({
                        type: "space"
                    ...
                    this.tokens.push({
                        ...
                        this.tokens.push(l), i = i[0].match(this.rules.item), c = [], n = !1, f = i.length, d = 0; d < f; d++) s = i[d],
                        p = s.length,
                        s = s.replace(/^ *([*+-]|\d+\.) */, ""),
                        ~s.indexOf("\n ") && (p -= s.length, s = this.options.pedantic ? s.replace(/^ {1,4}/gm, "") : s.replace(new RegExp("^ {1," + p + "}", "gm"), "")),
                        d !== f - 1 && (a = x.bullet.exec(i[d + 1])[0], (o.length > 1 ? 1 === a.length: a.length > 1 || this.options.smartLists && a !== o) && (e = i.slice(d + 1).join("\n") + e, d = f - 1)),
                        r = n || /\n\n(?!\s*$)/.test(s),
                        d !== f - 1 && (n = "\n" === s.charAt(s.length - 1), r || (r = n)),
                        r && (l.loose = !0),
                        b = /^\[[ xX]\] /.test(s),
                        w = void 0,
                        b && (w = " " !== s[1], s = s.replace(/^\[[ xX]\] +/, "")),
                        u = {
                ...
                w._punctuation = "!\"#$%&'()*+,\\-./:;<=>?@\\[^_{|}~",
                w.em = u(w.em).replace(/punctuation/g, w._punctuation).getRegex(),
                w._escapes = /\\([!"#$%&'()*+,\-.\/:;<=>?@\[\]\\^_`{|}~])/g,
                ...
                w.tag = u(w.tag).replace("comment", x._comment).replace("attribute", w._attribute).getRegex(),
                w._label = /(?:\[[^\[\]]*\]|\\[\[\]]?|`[^`]*`|[^\[\]\\])*?/,
                w._href = /\s*(<(?:\\[<>]?|[^\s<>\\])*>|[^\s\x00-\x1f]*)/,
                w._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/,
                w.link = u(w.link).replace("label", w._label).replace("href", w._href).replace("title", w._title).getRegex(),
                w.reflink = u(w.reflink).replace("label", w._label).getRegex(),
                w.normal = f({},
                w),
                w.pedantic = f({},
                w.normal, {
                ...
                r.prototype.output = function(e) {
                    for (var t, n, i, o, a, s, c = ""; e;) if (a = this.rules.escape.exec(e)) e = e.substring(a[0].length),
                    c += l(a[1]);
                    ...
                    "@" === a[2] ? (n = l(this.mangle(a[1])), i = "mailto:" + n) : (n = l(a[1]), i = n),
        ...
        d = function() {
            ...
            return i(e, [{
                ...
                value: function(e) {
                    ...
                    try {
						$("span").removeClass("token comment");
                        ...
                        for (var d in p) {
                            ...
                            f.setAttribute("src", e.emoticon_url + "/" + p[d]),
                            s.appendChild(f)
                        }
                        c || (n.init({
                    ...
                    t.alert = {
                        show: function(e) {
                            ...
                            if (n.innerHTML = "" + r + (e.type && i), x.querySelector(".vcancel").addEventListener("click",
                            function(e) {
                                t.alert.hide()
                    ...
                    y.equalTo("url", l.url + "/"),
                    AV.Query.or(w, y).count().then(function(n) {
            ...
            },
            {
                ...
                value: function(e) {
                    ...
                    var i = function(e) {
                        e.offsetHeight > 180 && (e.classList.add("expand"), h.on("click", e,
                        function(t) {
                    ...
                    c = function() {
                        ...
                        return r.notEqualTo("isSpam", !0),
                        r.select(["nick", "comment", "link", "rid", "emailHash"]),
                    ...
                    var d = function(e) {
                        ...
                        a = "https://gravatar.loli.net/avatar/" + o + "?size=80&d=https%3a%2f%2fgravatar.loli.net%2favatar%2f9e63c80900d106cbbec5a9f4ea433a3e.jpg%3fsize%3d80";
                    ...
                    t.reset = function() {
                        ...
                        _.getAttribute("triggered") && (_.setAttribute("style", "display:none;"), _.removeAttribute("triggered"))
                    };
                    ...
                    y = function(n) {
                        ...
                        l.mail = i.k ? i.v: "",
                        l.link = s.k ? s.v: "",
                        i.k || s.k ? i.k ? s.k ? z() : t.alert.show({
                            type: 0,
                    ...
                    function(e) {
                        _.getAttribute("triggered") && (_.setAttribute("style", "display:none;"), _.removeAttribute("triggered")),
                        A.getAttribute("triggered") ? (A.setAttribute("style", "display:none;"), A.removeAttribute("triggered")) : (A.removeAttribute("style"), A.setAttribute("triggered", 1))
                    });
                    var S = t.el.querySelector(".vpreview-btn"),
                    _ = t.el.querySelector(".vpreview-text");
                    h.on("click", S,
                    function(t) {
                        if (A.getAttribute("triggered") && (A.setAttribute("style", "display:none;"), A.removeAttribute("triggered")), _.getAttribute("triggered")) _.setAttribute("style", "display:none;"),
                        _.removeAttribute("triggered");
                        else {
                            if ("" == l.comment) return void m.comment.focus();
                    ...
                    z = function() {
                        ...
                        n.set("emailHash", s(l.mail.toLowerCase().trim())),
                        n.setACL(T()),
                    ...
                    L = function(e) {
                        ...
                        function(n) {
                            ...
                            l.rid = i,
                            l.at = r,
                            m.comment.value = r + " ，" + m.comment.value,
                            m.comment.focus(),
    ...
    function(e, t, n) {
        ...
        function h(e, t, n) {
            var r = n.css,
            i = n.sourceMap,
            o = void 0 === t.convertToAbsoluteUrls && i; (t.convertToAbsoluteUrls || o) && (r = w(r)),
    ...
    function(e, t, n) {
        ...
        function a(e) {
            e = o(e || {}),
            e.stripIgnoreTag && (e.onIgnoreTag && console.error('Notes: cannot use these two options "stripIgnoreTag" and "onIgnoreTag" at the same time'), e.onIgnoreTag = l.onIgnoreTagStripAll),
