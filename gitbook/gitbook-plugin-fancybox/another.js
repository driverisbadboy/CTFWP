require(['gitbook'], function(gitbook, $) {
	gitbook.events.on('page.change', function() {
		jQuery(document).ready(function ($) {
			...
			$('link[rel="shortcut icon"]').attr("href","/gitbook/images/favicon.ico");
			$('link[rel="apple-touch-icon-precomposed"]').attr("href","/gitbook/images/apple-touch-icon-precomposed-152.png");
			$(".gitbook-link").remove();
